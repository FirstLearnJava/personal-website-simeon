...
export default function AboutPage() {
  ...
  return (
    <div className="mt-[62px] lg:flex lg:flex-col lg:items-center  bg-projectBackground px-20 lg:px-12 sm:px-12 xs:px-7 pt-8 sm:pt-6 pb-8 sm:pb-6 min-h-[calc(100vh-112px)]">
