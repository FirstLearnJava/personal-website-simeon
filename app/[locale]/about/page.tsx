        ...
        <div className="flex justify-center px-20 mt-16 gap-12">
          ...
          <div className="w-1/2 mt-6">
            <p className="">
              ...
              und Gesang, Vokalensembles, Bands, Chören und Orchestern. Seit
              2017 leitet er Chöre in Deutschland und Österreich. Er erhielt
              akademische Abschlüsse an der Universität Freiburg und der
              Musikhochschule Freiburg i. Brsg. in den Fächern Musik,
              Philosophie/Ethik und Elementare Musikpädagogik (Bachelor of
              Music, B.mus.) mit den Hauptfächern Klassisches Klavier und Gesang
              Jazz/Pop. Seit 10 Jahren tanzt er im Bereich des Zeitgenössischen
              Tanzes u.a. in den Jugendensembles der Theater Konstanz und
              Freiburg und schließt im Sommer das Studium “Zeitgenössische
              Tanzpädagogik” an der Musik und Kunst Privatuniversität der Stadt
              Wien ab (B.A.). Die Arbeit mit Menschen im kunstpädagogischen
              Kontext macht ihm besonders Freude.{' '}
            </p>
          </div>
        </div>
      </div>
