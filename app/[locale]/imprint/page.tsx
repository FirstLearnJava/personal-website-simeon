...
export default function ImprintPage() {
  ...
  return (
    <div className="flex justify-center font-mont text-base font-medium pb-8 sm:pb-5 bg-projectBackground">
      <div className="flex flex-col gap-3 sm:gap-2 w-[80%] xxl:w-[86%] lg:w-full lg:px-9 md:px-7 mt-[62px]">
